...
ATL03_ATL08_join_dt <- function(atl03_h5,atl08_h5,
  ...
  for (i in beam) {
      ...
      segment_length <- c(0, cumsum(atl03_h5v2[[paste0(i,"/geolocation/segment_length")]][1:(n_segments - 1)]))
      segment_lengths <- rep(segment_length, segment_ph_cnt)

      segment_solar_elevation <- atl03_h5v2[[paste0(i,"/geolocation/solar_elevation")]][]
      ...
      dataTableATL03Photons <- data.table::data.table(data.frame(
        ...
        quality_ph=atl03_h5v2[[paste0(i,"/heights/quality_ph")]][],
        solar_elevation=ph_solar_elev,
        dist_ph_along = atl03_h5v2[[paste0(i,"/heights/dist_ph_along")]][] + segment_lengths
      ))
      ...
      dataTableATL08Photons <- data.table::data.table(data.frame(
        ...
        d_flag = atl08_h5v2[[paste0(i,"/signal_photons/d_flag")]][],
        delta_time = atl08_h5v2[[paste0(i,"/signal_photons/delta_time")]][],
        ph_h = atl08_h5v2[[paste0(i,"/signal_photons/ph_h")]][]
