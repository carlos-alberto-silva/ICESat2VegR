# ATL08.var.map
ATL08.var.map <- list()
ATL08.var.map[["segment_watermask"]] <- "/land_segments/segment_watermask"
ATL08.var.map[["delta_time_end"]] <- "/land_segments/delta_time_end"
ATL08.var.map[["latitude_20m"]] <- "/land_segments/latitude_20m"
ATL08.var.map[["rgt"]] <- "/land_segments/rgt"
ATL08.var.map[["dem_flag"]] <- "/land_segments/dem_flag"
ATL08.var.map[["msw_flag"]] <- "/land_segments/msw_flag"
ATL08.var.map[["cloud_flag_atm"]] <- "/land_segments/cloud_flag_atm"
ATL08.var.map[["snr"]] <- "/land_segments/snr"
ATL08.var.map[["canopy"]] <- "/land_segments/canopy"
ATL08.var.map[["sigma_across"]] <- "/land_segments/sigma_across"
ATL08.var.map[["terrain"]] <- "/land_segments/terrain"
ATL08.var.map[["layer_flag"]] <- "/land_segments/layer_flag"
ATL08.var.map[["segment_snowcover"]] <- "/land_segments/segment_snowcover"
ATL08.var.map[["beam_azimuth"]] <- "/land_segments/beam_azimuth"
ATL08.var.map[["solar_azimuth"]] <- "/land_segments/solar_azimuth"
ATL08.var.map[["psf_flag"]] <- "/land_segments/psf_flag"
ATL08.var.map[["longitude"]] <- "/land_segments/longitude"
ATL08.var.map[["latitude"]] <- "/land_segments/latitude"
ATL08.var.map[["segment_id_end"]] <- "/land_segments/segment_id_end"
ATL08.var.map[["longitude_20m"]] <- "/land_segments/longitude_20m"
ATL08.var.map[["surf_type"]] <- "/land_segments/surf_type"
ATL08.var.map[["brightness_flag"]] <- "/land_segments/brightness_flag"
ATL08.var.map[["segment_landcover"]] <- "/land_segments/segment_landcover"
ATL08.var.map[["ph_removal_flag"]] <- "/land_segments/ph_removal_flag"
ATL08.var.map[["asr"]] <- "/land_segments/asr"
ATL08.var.map[["sigma_atlas_land"]] <- "/land_segments/sigma_atlas_land"
ATL08.var.map[["segment_id_beg"]] <- "/land_segments/segment_id_beg"
ATL08.var.map[["sigma_along"]] <- "/land_segments/sigma_along"
ATL08.var.map[["dem_h"]] <- "/land_segments/dem_h"
ATL08.var.map[["beam_coelev"]] <- "/land_segments/beam_coelev"
ATL08.var.map[["sat_flag"]] <- "/land_segments/sat_flag"
ATL08.var.map[["sigma_topo"]] <- "/land_segments/sigma_topo"
ATL08.var.map[["night_flag"]] <- "/land_segments/night_flag"
ATL08.var.map[["delta_time_beg"]] <- "/land_segments/delta_time_beg"
ATL08.var.map[["sigma_h"]] <- "/land_segments/sigma_h"
ATL08.var.map[["last_seg_extend"]] <- "/land_segments/last_seg_extend"
ATL08.var.map[["atlas_pa"]] <- "/land_segments/atlas_pa"
ATL08.var.map[["ph_ndx_beg"]] <- "/land_segments/ph_ndx_beg"
