...
#'
#' @param atl08_seg_att_dt  An S4 object of class [rICESat2Veg::icesat2.atl08_dt] containing
#' ATL08 terrain and canopy attributes (output of [rICESat2Veg::ATL08_canopy_attribute_dt()] function).
...
#'h_canopy_metrics <-ATL08_seg_attributes_dt_polyStat(atl08_seg_att_dt, func=mySetOfMetrics(h_canopy),poly_id="poly_id")
